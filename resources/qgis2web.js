...
map.getView().fit([-9348881.223395, -544343.572622, -8007193.152853, 157505.430726], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Amenazas en Reservas de Jocotoco</h2>';
        return titleElement;
    })(),
